...
function App() {
  ...
  return (
    <BrowserRouter>
      ...
      <footer className='w-full flex text-white py-4 bg-[#002647]'>
        <div className='flex w-1/4 inline-block'>
          <a className='text-xs pl-16'>&#169;2023 Startoon Labs, Inc.</a>
        </div>
        <div className='flex w-1/2 inline-block text-xs items-center justify-center'>
        ...
        <div className='flex w-1/4 inline-block items-center justify-center'>
