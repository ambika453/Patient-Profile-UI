...
function App() {
  ...
  return (
    <BrowserRouter>
      <header className='bg-[#002647] py-3 border border-[#002647] shadow text-white'>
        <div className='flex flex-col justify-center pl-6'>
          <h1 className='font-bold text-l'>STARTOON LABS</h1>
        </div>
      </header>
      <Routes>
        <Route path='/' element={<Profile />} />
      </Routes>
      <footer className='container w-full flex flex-col lg:flex-row items-center justify-center text-white py-4 bg-[#002647] shadow'>
        <div className='w-full lg:w-3/4 flex lg:flex-row md:flex-row flex-col justify-center items-center lg:pb-0 pb-4'>
          <div className='lg:w-1/3 md:w-1/2 lg:pl-16 md:pl-6 pl-8 lg:pb-2 md:pb-2 pb-4'>
            <a className='text-xs'>&#169;2023 Startoon Labs, Inc.</a>
          </div>
          <div className='lg:w-2/3 md:w-full flex flex-row text-xs items-center justify-center lg:pb-0 pb-2'>
            <a href="#" className='px-4 lg:px-2 hover:underline'>Terms Of Use</a>
            <a href="#" className='px-4 lg:px-2 hover:underline'>Privacy Policy</a>
            <a href="#" className='px-4 lg:px-2 hover:underline'>Cookie Page</a>
            <a href="#" className='px-4 lg:px-2 hover:underline'>Contact Us </a>
          </div>
        </div>
        <div className='flex w-full lg:w-1/4 flex-row items-center justify-center'>
          <a href="#" aria-label="facebook" className='px-3'>
          ...
          <a href="#" aria-label="instagram" className='px-3'>
          ...
          <a href="#" aria-label="twitter" className='px-3'>
          ...
          <a href="#" aria-label="youtube" className='px-3'>
